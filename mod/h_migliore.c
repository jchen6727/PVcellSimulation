...
#define dt _nt->_dt
#define ehd _p[0]
#define ehd_columnindex 0
#define gbar _p[1]
#define gbar_columnindex 1
#define vhalfl _p[2]
#define vhalfl_columnindex 2
#define clk _p[3]
#define clk_columnindex 3
#define elk _p[4]
#define elk_columnindex 4
#define i _p[5]
#define i_columnindex 5
#define lk _p[6]
#define lk_columnindex 6
#define glk _p[7]
#define glk_columnindex 7
#define l _p[8]
#define l_columnindex 8
#define Dl _p[9]
#define Dl_columnindex 9
#define ghd _p[10]
#define ghd_columnindex 10
#define v _p[11]
...
#define gmt gmt_hd
 double gmt = 0.4;
#define linf_hd _thread1data[0]
#define linf _thread[_gth]._pval[0]
#define qtl qtl_hd
 double qtl = 1;
#define q10 q10_hd
 double q10 = 4.5;
#define taul_hd _thread1data[1]
#define taul _thread[_gth]._pval[1]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 0, "cvodeieq");
 	...
 	ivoc_help("help ?1 hd h_migliore.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "h_migliore.mod";
static const char* nmodl_file_text = 
